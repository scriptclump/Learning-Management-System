...
<div class="page-head">
   <ol class="breadcrumb">
      <li class="active"><i class="fa fa-plus-square"></i>&nbsp;<?php echo $this->Html->link(__('New Newsletter'), array('action' => 'add')); ?></li>
   </ol>
</div>
<div class="block block-color primary">
   ...
   <div class="content">
            ...
            <div class="bs_border_container">
               ...
               <div class="content">
                  <?php
                     ...
                     echo $this->Form->input('subject', array('class' => 'form-control parsley-validated', 'placeholder' => 'Enter subject to search', 'label' => array('class' => 'col-sm-2 control-label', 'text' => 'Subject') ));
      ...
      <div class="row">&nbsp;</div>
      <?php echo $this->Form->create('Newsletter', array('action' => 'bulk_action/','onsubmit'=>'return confirm("Are you sure, you want to perform the bulk actions?");')); ?>
            ...
            <div id="datatable2_wrapper" class="dataTables_wrapper form-inline no-footer">
               <table class="table table-bordered" id="datatable2" >
                  ...
                  <tbody>
                     ...
                     <tr>
                        <td><?php echo $this->Form->checkbox('del_item.', array('class' => 'del_item', 'hiddenField' => false, 'value' => $newsletter['Newsletter']['id'] ) ); ?></td>
                        <td><?php echo h($newsletter['Newsletter']['id']) ?></td>
                        <td><?php echo $this->Text->excerpt($newsletter['Newsletter']['subject'], 'method', 80, ''); ?>
                        </td>
                        <td align="center"><?php echo $this->Html->link($this->Html->image('icon_' . $newsletter['Newsletter']['status'] . '.png'), array('controller' => 'newsletters', 'action' => 'switch', 'status', $newsletter['Newsletter']['id']), array('class' => 'status', 'escape' => false)); ?></td>
                        ...
                        <td>
                           <div class="btn-group">
                              ...
                              <ul role="menu" class="dropdown-menu">
                                 ...
                                 <li><?php echo $this->Html->link(__('Details'), array('action' => 'view', $newsletter['Newsletter']['id'])); ?></li>
                                 <li class="divider"></li>
                                 <li>
                                    <?php
                                       echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $newsletter['Newsletter']['id']), null, __('Are you sure you want to delete # %s?', $newsletter['Newsletter']['id']));
                                       ?>
                                 </li>
                              </ul>
                           </div>
                  ...
                  <div class="col-sm-12">
                     ...
                     <div class="pull-right">
                        <div class="dataTables_paginate paging_bs_normal" id="datatable2_paginate">
                           <?php if( $this->Paginator->params['paging']['Newsletter']['pageCount'] > 1 ){ ?>
                           <ul class="pagination">
                              <?php
