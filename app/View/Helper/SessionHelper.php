 ...
 */
	...
	// }
	// 
	// Updated by Basant sharma in order to get custom notification.
		...
		if(CakeSession::check('flashMessages')) {
			...
			foreach ($messages as $type => $message) {
				foreach ($message as $text){
					if( $type == 'error'){
						$out .= '<div class="alert alert-danger alert-white-alt rounded">
							        <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
							        <div class="icon"><i class="fa fa-times-circle"></i></div>
							        <strong>Error!</strong> '.htmlspecialchars($text).'
							      </div>';
					}

					if( $type == 'notice'){
						$out .= '<div class="alert alert-info alert-white-alt rounded">
							        <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
							        <div class="icon"><i class="fa fa-info-circle"></i></div>
							        <strong>Info!</strong> '.htmlspecialchars($text).'
							      </div>';
					}

					if( $type == 'success'){
						$out .= '<div class="alert alert-success alert-white-alt rounded">
							        <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
							        <div class="icon"><i class="fa fa-check"></i></div>
							        <strong>Success!</strong> '.htmlspecialchars($text).'
							     </div>';
					}

					if( $type == 'warning'){
						$out .= '<div class="alert alert-warning alert-white-alt rounded">
							        <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
							        <div class="icon"><i class="fa fa-warning"></i></div>
							        <strong>Alert!</strong> '.htmlspecialchars($text).'
							     </div>';
					}

					if( $type == 'great'){
						$out .= '<div class="alert alert-primary alert-white-alt rounded">
							        <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
							        <div class="icon"><i class="fa fa-check"></i></div>
							        <strong>Great!</strong> '.htmlspecialchars($text).'
							      </div>';
					}

					if( $type == 'frontend_error'){
						$out .= '<div class="cus_error" id="msg"><i class="fa fa-times-circle"></i>'.htmlspecialchars($text).'
							      </div>';
					}

					if( $type == 'frontend_notice'){
						$out .= '<div class="cus_info" id="msg"><i class="fa fa-info-circle"></i>'.htmlspecialchars($text).'
							      </div>';
					}

					if( $type == 'frontend_success'){
						$out .= '<div class="cus_success" id="msg"><i class="fa fa-check-circle"></i>'.htmlspecialchars($text).'
							     </div>';
					}

					if( $type == 'frontend_warning'){
						$out .= '<div class="cus_warning" id="msg"><i class="fa fa-exclamation-circle"></i>'.htmlspecialchars($text).'
							     </div>';
					}
