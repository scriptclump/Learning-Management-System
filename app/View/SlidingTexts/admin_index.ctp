...
<div class="page-head">
   <ol class="breadcrumb">
      <li class="active"><i class="fa fa-plus-square"></i>&nbsp;<?php echo $this->Html->link(__('New Sliding Text'), array('action' => 'add')); ?></li>
   </ol>
</div>
<div class="block block-color primary">
   <div class="header">
      <h3><?php echo __('Sliding Texts'); ?></h3>
   </div>
   <div class="content">
      <div class="row">
      ...
      <div class="row">&nbsp;</div>
      <?php echo $this->Form->create('SlidingText', array('action' => 'bulk_action/','onsubmit'=>'return confirm("Are you sure, you want to perform the bulk actions?");')); ?>
               ...
               <table class="table table-bordered" id="datatable2" >
                  <thead>
                     <tr>
                        ...
                        <th><?php echo $this->Paginator->sort('body','Content'); ?></th>
                  ...
                  <tbody>
                     ...
                     <tr>
                        <td><?php echo $this->Form->checkbox('del_item.', array('class' => 'del_item', 'hiddenField' => false, 'value' => $slidingText['SlidingText']['id'] ) ); ?></td>
                        <td><?php echo h($slidingText['SlidingText']['id']) ?></td>
                        <td><?php //echo $this->Text->excerpt($slidingText['SlidingText']['body'], 'method', 80, '');
                        echo $slidingText['SlidingText']['body']; ?>
                        </td>
                        <td align="center"><?php echo h($slidingText['SlidingText']['sort_order']) ?></td>
                        <td align="center"><?php echo $this->Html->link($this->Html->image('icon_' . $slidingText['SlidingText']['status'] . '.png'), array('controller' => 'slidingTexts', 'action' => 'switch', 'status', $slidingText['SlidingText']['id']), array('class' => 'status', 'escape' => false)); ?></td>
                        <td>
                           <div class="btn-group">
                              ...
                              <ul role="menu" class="dropdown-menu">
                                 <li><?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $slidingText['SlidingText']['id'])); ?></li>
                                 <li><?php echo $this->Html->link(__('Details'), array('action' => 'view', $slidingText['SlidingText']['id'])); ?></li>
                                 <li class="divider"></li>
                                 <li>
                                    <?php
                                       echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $slidingText['SlidingText']['id']), null, __('Are you sure you want to delete # %s?', $slidingText['SlidingText']['id']));
                                       ?>
                                 </li>
                              </ul>
                           </div>
                  ...
                  <div class="col-sm-12">
                     ...
                     <div class="pull-right">
                        <div class="dataTables_paginate paging_bs_normal" id="datatable2_paginate">
                           <?php if( $this->Paginator->params['paging']['SlidingText']['pageCount'] > 1 ){ ?>
                           <ul class="pagination">
                              <?php
