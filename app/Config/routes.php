 ...
 */
	Router::connect('/', array('controller' => 'Cmspages', 'action' => 'home', 'home'));
/**
 ...
 */
	...
	Router::connect('/newsletters/thank-you', array('controller' => 'NewsletterSubscribers', 'action' => 'thank_you'));

	Router::connect('/contactenos', array('controller' => 'ContactUs', 'action' => 'index'));
	Router::connect('/register', array('controller' => 'Users', 'action' => 'register'));
	Router::connect('/login', array('controller' => 'Users', 'action' => 'login'));
	Router::connect('/communications/:id', array('controller' => 'Communications', 'action' => 'index', 'id' => '[0-9]+'));
